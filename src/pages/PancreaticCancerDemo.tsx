...
import { Loader2, BrainCircuit, Image, ArrowRight } from "lucide-react";
...
const PancreaticCancerDemo = () => {
  ...
  const runSegmentation = async () => {
    ...
    try {
      ...
      const scan = SAMPLE_SCANS.find(s => s.id === selectedScan);
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-background border rounded-xl shadow-sm p-6">
                <h2 className="text-xl font-semibold mb-4">Select a CT Scan</h2>
              ...
              <div className="border-2 border-dashed border-muted-foreground/20 rounded-lg h-[400px] flex items-center justify-center overflow-hidden bg-black/5">
                {segmentationResult ? (
                  <div className="relative w-full h-full">
                    ...
                    {SAMPLE_SCANS.find(s => s.id === selectedScan)?.hasAbnormality && (
              ...
              {segmentationResult && (
                <div className="mt-4 bg-secondary/30 p-4 rounded-lg">
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    ...
                    <Badge variant="outline" className="bg-background">
                      Processing Time: {Math.round(1.2 + Math.random() * 0.8, 1)}s
                    </Badge>
                  </div>
                </div>
              )}
